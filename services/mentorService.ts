...
import { UserProfile, Opportunity, PlanJSON, PDFJSON, PPTJSON, ExcelJSON } from '../types';
...
export const MentorService = {
  ...
  async voiceReply(history: {role:string, text:string}[], lastInput: string): Promise<{replyText: string, followUpQuestion: string}> {
